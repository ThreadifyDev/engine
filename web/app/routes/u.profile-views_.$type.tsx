...
function ProfileViewDesigner({ type }: { type: string }) {
  ...
  return <div className="min-w-0 p-4 sm:p-6 lg:p-8">
    ...
    <header className="mb-6 flex flex-wrap items-start justify-between gap-4">
      <div className="min-w-0"><p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-gray-500">Profile configuration</p><h1 className="break-words text-2xl font-semibold tracking-tight text-gray-900">{type}</h1><p className="mt-2 max-w-xl text-sm leading-relaxed text-gray-500">Define the data once, then choose how each profile presents it.</p></div>
