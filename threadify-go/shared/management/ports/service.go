...
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/api_key/api_key_mocks.go threadify-go/shared/management/ports APIKeyService
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/auth/auth_mocks.go threadify-go/shared/management/ports AuthService
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/agent/agent_mocks.go threadify-go/shared/management/ports AgentService
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/service_account/service_account_mocks.go threadify-go/shared/management/ports ServiceAccountService
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/team_invitation/team_invitation_mocks.go threadify-go/shared/management/ports TeamInvitationService
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/entity_profile_type/entity_profile_type_mocks.go threadify-go/shared/management/ports EntityProfileTypeService
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/user/user_mocks.go threadify-go/shared/management/ports UserService
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/billing/billing_mocks.go threadify-go/shared/management/ports BillingService
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/permission/permission_mocks.go threadify-go/shared/management/ports PermissionLoader
//go:generate mockgen -package=svcmocks -destination=../service/mocks/service/rbac/rbac_mocks.go threadify-go/shared/management/ports RBACRoleLoader
