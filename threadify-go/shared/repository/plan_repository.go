...
func (r *PlanRepo) GetCreditAccount(ctx context.Context, companyID string) (*domain.CreditAccount, error) {
	const query = `
		SELECT 
...
func (r *PlanRepo) CreateCreditAccount(ctx context.Context, account *domain.CreditAccount) error {
	const query = `
