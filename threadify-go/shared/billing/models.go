...
type PlanService interface {
	...
	GetCurrentLimits(ctx context.Context, companyID string) (*models.CreditAccount, error)
	...
	CheckPayloadSize(ctx context.Context, account *models.CreditAccount, payloadBytes int64) error
	CheckRateLimit(ctx context.Context, account *models.CreditAccount) (bool, error)
	CheckCreditAvailable(ctx context.Context, companyID, meter string, amount int64) error
	CheckBalancePositive(ctx context.Context, companyID string) (*models.CreditAccount, error)
}
