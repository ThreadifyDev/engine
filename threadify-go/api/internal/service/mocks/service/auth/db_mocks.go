...
// Source: threadify-go/shared/management/ports (interfaces: DBPool,Tx)
...
import (
	context "context"
	reflect "reflect"
	ports "threadify-go/shared/management/ports"
...
func (m *MockDBPool) Begin(arg0 context.Context) (ports.Tx, error) {
	m.ctrl.T.Helper()
