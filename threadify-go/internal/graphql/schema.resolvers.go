...
/*
	func (r *stepStateInfoResolver) StartedAt(ctx context.Context, obj *models.StepStateInfo) (*string, error) {
	if obj.StartedAt == nil {
		return nil, nil
	}
	return obj.StartedAt, nil
}
func (r *stepStateInfoResolver) FinishedAt(ctx context.Context, obj *models.StepStateInfo) (*string, error) {
